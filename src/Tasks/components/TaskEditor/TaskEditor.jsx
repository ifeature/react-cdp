  ...
  render() {
    return (
      <div className="task-editor">
        ...
        <InputGroup>
          <Label check>
            <Input type="checkbox" defaultChecked={this.props.done} getRef={(node) => this.done = node}/>{' '}
              Done
            </Label>
          </InputGroup>
          <InputGroup>
            <Input type="textarea" defaultValue={this.props.task.description} getRef={(node) => this.description = node} />
          </InputGroup>
        </div>
      );
    }
